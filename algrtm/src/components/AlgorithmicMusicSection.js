...
const AlgorithmicMusicSection = () => {
  return (
    <section className="flex flex-col md:flex-row gap-[1.5rem] md:gap-16 py-[2.75rem] px-[1rem] md:px-[2.75rem] md:py-[5.88rem] text-neutralLight-neutral10 items-center">
