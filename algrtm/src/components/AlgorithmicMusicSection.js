...
const AlgorithmicMusicSection = () => {
  return (
    <section className="flex flex-col xl:flex-row gap-[1.5rem] xl:gap-16 py-[2.75rem] px-[1rem] xl:px-[2.75rem] xl:py-[5.88rem] text-neutralLight-neutral10 items-center">
