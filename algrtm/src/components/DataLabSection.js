...
const DataLabSection = () => {
  return (
    <section className="w-full self-stretch max-w-[78.25rem] flex flex-col gap-6 items-start mt-[2.75rem] mx-[1rem] md:max-w-[54.875rem] md:mt-[7.75rem md:mx-[4.56rem] xl:m-[5.88rem] bg-neutralLight-neutral100 dark:bg-neutralDark-neutral100">
      <h4 className="h4 lg:h2SB xl:h2 text-start">Our Data Laboratory</h4>
