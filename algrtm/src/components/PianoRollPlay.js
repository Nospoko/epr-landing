...
const PianoRollPlay = () => {
  return (
    <section className="flex flex-col items-center gap-[2.75rem] md:gap-[5.88rem] my-[4rem] md:my-[7.19rem]">
      <div className="text-neutralLight-neutral10 h5 md:h5_500 md:px-[7.75rem] lg:px-[4rem] flex items-center max-w-[51.875rem]">
        <p>
