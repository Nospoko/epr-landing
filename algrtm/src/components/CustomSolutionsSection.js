  ...
  return (
    <section className="flex mt-[0rem] md:mt-[3.94rem] w-full relative overflow-hidden">
      <div className="flex flex-col gap-4 xl:gap-[1.5rem] py-[4rem] xl:pl-[9.75rem] pr-[0rem]">
        <h1 className="h2 md:h1SB xl:h1 text-neutralLight-neutral10 leading-[5.375rem]">
          Custom Solutions
        </h1>
        <div className="flex flex-col gap-8">
          {" "}
          <div className="leading-[1.98rem] text-neutralLight-neutral20 h6_400 md:h6 max-w-[40.063rem]">
            <p>
