...
const SoftwareConsultingSection = () => {
  return (
    <section className="flex flex-col gap-[1.5rem] lg:gap-[4rem] self-stretch lg:mx-[2.75rem] xl:mx-[6.75rem] lg:my-[1.5rem] xl:my-[5.88rem] text-neutralLight-neutral10 dark:text-neutralDark-neutral10">
