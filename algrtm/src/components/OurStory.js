...
const OurStory = () => {
  return (
    <section className="bg-neutralLight-neutral90 text-neutralLight-neutral10 w-full max-w-[78.25rem] flex flex-col items-start px-[6.75rem] py-[5.88rem] rounded-[2rem]">
